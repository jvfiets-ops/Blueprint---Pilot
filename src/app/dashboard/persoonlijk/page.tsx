        ...
        {data.personality ? (
          <div className="rounded-2xl border border-[#2a3e33] bg-[#1a2e23] p-5">
            <div className="mb-3 flex items-center justify-between">
              ...
              <Link href="/dashboard/persoonlijkheid" className="text-[10px] text-[#c9a67a] hover:underline">Bekijk →</Link>
            </div>
          ...
          <EmptyCard title="Persoonlijkheid" desc="Ontdek je Big 5 profiel" href="/dashboard/persoonlijkheid" icon="🧬" />
        )}
        ...
        {data.profiles.length > 0 ? (
          <div className="rounded-2xl border border-[#2a3e33] bg-[#1a2e23] p-5">
            <div className="mb-3 flex items-center justify-between">
              ...
              <Link href="/dashboard/reflectie/beste-versie" className="text-[10px] text-[#c9a67a] hover:underline">Bewerk →</Link>
            </div>
            {data.profiles.map((p) => (
          ...
          <EmptyCard title="Beste versie" desc="Definieer je ideale prestatieprofiel" href="/dashboard/reflectie/beste-versie" icon="⭐" />
        )}
        ...
        {data.roleModels.length > 0 ? (
          <div className="rounded-2xl border border-[#2a3e33] bg-[#1a2e23] p-5">
            <div className="mb-3 flex items-center justify-between">
              ...
              <Link href="/dashboard/reflectie/rolmodellen" className="text-[10px] text-[#c9a67a] hover:underline">Bekijk →</Link>
            </div>
            <div className="space-y-2">
          ...
          <EmptyCard title="Rolmodellen" desc="Wie inspireert jou?" href="/dashboard/reflectie/rolmodellen" icon="🌟" />
        )}
        ...
        {data.mentors.length > 0 ? (
          <div className="rounded-2xl border border-[#2a3e33] bg-[#1a2e23] p-5">
            <div className="mb-3 flex items-center justify-between">
              ...
              <Link href="/dashboard/reflectie/mentoren" className="text-[10px] text-[#c9a67a] hover:underline">Bekijk →</Link>
            </div>
            <div className="space-y-2">
              {data.mentors.map((m) => (
                <div key={m.name} className="flex items-start gap-3 rounded-xl bg-[#152620] p-3">
          ...
          <EmptyCard title="Mentoren" desc="Wie begeleidt jou?" href="/dashboard/reflectie/mentoren" icon="🧭" />
        )}
        ...
        {data.memory ? (
          <div className="rounded-2xl border border-[#2a3e33] bg-[#1a2e23] p-5 md:col-span-2">
            <div className="mb-3 flex items-center justify-between">
              ...
              <Link href="/dashboard/stressoren/mentaal/geschiedenis" className="text-[10px] text-[#c9a67a] hover:underline">Geschiedenis →</Link>
            </div>
            {data.memory.summary && (
        ...
        {data.recentReflections.length > 0 && (
          <div className="rounded-2xl border border-[#2a3e33] bg-[#1a2e23] p-5">
            <div className="mb-3 flex items-center justify-between">
              ...
              <Link href="/dashboard/geschiedenis" className="text-[10px] text-[#c9a67a] hover:underline">Alles →</Link>
            </div>
            <div className="space-y-1.5">
